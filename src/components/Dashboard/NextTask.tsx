...
import { PiCheck, PiNoteDuotone } from "react-icons/pi";
import SecondaryNextTaskContainer from "./SecondaryNextTaskContainer";
import PrimaryNextTaskContainer from "./PrimaryNextTaskContainer";
          ...
          <div className="p-4 flex flex-col space-y-4">
            ...
            <div className="flex flex-row space-x-2 items-center">
              <TaskLink href="/task" external={false}>
                <PiNoteDuotone className="text-blue-500 w-fit inline-flex" />
                <span>notes</span>
              </TaskLink>
